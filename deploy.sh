...
PORT='1904' #Insert the port number here
PROTOCOL='UDP' #Insert  the protocol here
...
docker run -d -p 1904:1904/udp --name $SERVER_CONTAINER --network $PROJECT_NETWORK $SERVER_IMAGE
